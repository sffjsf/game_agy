...
export function executeTrainStampede(caster, skill, weaponSystem, effectSystem, dx, dy, dist) {
{
  ...
  var proj = weaponSystem.createRangedAttack(caster.x, caster.y, caster.target.x, caster.target.y, skill.damage, caster.team, 'train', caster.charData.color, caster, caster._opposingTeam);
